<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="DistrictDirectory_Default" EnableEventValidation="false" %>
...
<body >
    <form id="form1" runat="server">
        <div class="top_header">
            <div class="holder">
                <div class="admin_panel ">
                    <img src="../admin_icons/setting.png" width="33" height="31" alt="" style="vertical-align: middle" /><span class="admin_panel_text">Admin Panel 4.1.0</span></div>
        ...
        <footer style="margin-top: 50px;">
            ...
            <div align="center" style="border-top: 1px solid #aeaeae; padding-top: 10px;">Copyright © 2019 RI District 3141. All Rights Reserved. | Site Designed & Maintained By <a href="http://www.goradiainfotech.com/" target="_blank">Goradia Infotech</a></div>
