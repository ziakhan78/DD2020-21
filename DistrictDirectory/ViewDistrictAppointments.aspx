<%@ Page Title="" Language="C#" MasterPageFile="~/DistrictDirectory/AdminDistrictDirectory.master" AutoEventWireup="true" CodeFile="ViewDistrictAppointments.aspx.cs" Inherits="DistrictDirectory_ViewDistrictAppointments" %>
                                ...
                                <tr>
                                    ...
                                    <td width="30%" align="right">
                                        <asp:Button ID="btnSendMailtoAG" runat="server" CssClass="btn"
                                             Text="Send Mail to AG" OnClick="btnSendMailtoAG_Click" Visible="false"  />
                                        &nbsp;<asp:Button ID="btnSendDta" runat="server" CssClass="btn" Visible="false"
                                             Text="Send DTA" OnClick="btnSendDta_Click" /> &nbsp;<asp:Button ID="btnSendLoginPass" Visible="false" runat="server" CssClass="btn" OnClick="btnSendLoginPass_Click" Text="Send Appointment Letter" />
                                    </td>
                                </tr>
                            </table>
                        </asp:Panel>
