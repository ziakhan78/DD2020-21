...
public partial class DistrictDirectory_ViewDesignations : System.Web.UI.Page
{
    ...
    protected void RadGrid1_ItemCommand(object sender, Telerik.Web.UI.GridCommandEventArgs e)
    {
        ...
        if (e.CommandName == "Delete")
        {
            ...
            desig.Id = id;
            int exe = desig.DeleteSubDesignation();
    ...
    private void SearchByAlphabet(string name)
    {
        ...
        obj.SetCommandSP = "z_SearchByAlphabetDisttSubDesig";
    ...
    private void BindGrid()
    {
        ...
        currentyears = "2020 - 2021";

        DataTable dt = new DataTable();
        DBconnection obj = new DBconnection();
        obj.SetCommandQry = "SELECT * FROM View_SubDesignations where years='" + currentyears + "' order by sub_designation asc";
        dt = obj.ExecuteTable();
        if (dt.Rows.Count > 0)
        {
            lblMsg.Visible = false;
    ...
    private void BindGrid(string yrs)
    {
        DataTable dt = new DataTable();
        DBconnection obj = new DBconnection();
        obj.SetCommandQry = "SELECT * FROM View_SubDesignations where years='" + yrs + "' order by designation, sub_designation ";
