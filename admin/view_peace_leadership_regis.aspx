<%@ Page Title="" Language="C#" MasterPageFile="~/masterpages/AdminM.master" AutoEventWireup="true" CodeFile="view_peace_leadership_regis.aspx.cs" Inherits="admin_view_peace_leadership_regis" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
   ...
   <table style="width:100%;" class="txt" >
            ...
            <tr>              
               <td class="header_title" colspan="3" >View Peace Through Leadership Seminar Registration
               </td>
            </tr>
