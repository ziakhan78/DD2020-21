<%@ Page Title="" Language="C#" MasterPageFile="~/masterpages/AdminM.master" AutoEventWireup="true" CodeFile="rpt_registration_reg_ord.aspx.cs" Inherits="admin_rpt_registration_reg_ord" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table width="100%" class="txt">
        <tr>
            <td class="header_title">Peace Through Leadership Seminar Registration Report - Order By Registration No.
            </td>
        </tr>
        ...
        <tr>
            <td>
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server"
                    ...
                    SelectCommand="Select ROW_NUMBER () OVER (ORDER BY regis_no asc) AS Sr, * from View_Peace_Leadership_Seminar order by regis_no"></asp:SqlDataSource>
