<%@ Page Language="C#" MasterPageFile="~/masterpages/AdminM.master" AutoEventWireup="true" CodeFile="ViewBod.aspx.cs" Inherits="user_ViewBod" Title="" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <table width="100%" class="txt">
                ...
                <tr>
                    <td colspan="3" class="header_title">View Board Members
                    </td>
                </tr>
                                    ...
                                    <table width="100%">
                                        ...
                                        <tr>
                                            <td valign="top" bordercolor="#ffffff" align="left">
                                                <asp:RadioButtonList ID="rbtnSearch" runat="server"
                                                    RepeatDirection="Horizontal" OnSelectedIndexChanged="rbtnSearch_SelectedIndexChanged" AutoPostBack="True">
                                        ...
                                        <tr>
                                            <td valign="top" bordercolor="#ffffff" align="left">
                                                ...
                                                <asp:DropDownList ID="ddlSearchYear" runat="server" DataSourceID="DSYears" DataTextField="year" DataValueField="year" AutoPostBack="True" AppendDataBoundItems="true" OnSelectedIndexChanged="ddlSearchYear_SelectedIndexChanged" CssClass="txt">
                                                    <asp:ListItem Value="0" Text="Select Year">Select Year</asp:ListItem>
                                                </asp:DropDownList>
                                                <asp:SqlDataSource ID="DSYears" runat="server" ConnectionString="<%$ ConnectionStrings:ConnString %>" SelectCommand="SELECT distinct [year] FROM [bod_tbl] where year!=' ' ORDER BY [year] DESC"></asp:SqlDataSource>
                                                 <asp:SqlDataSource ID="DSDistClubNo" runat="server" ConnectionString="<%$ ConnectionStrings:ConnString %>" SelectCommand="SELECT club_name,id from clubs_tbl where district_no='3141' order by club_name asc"></asp:SqlDataSource>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="left">
                ...
                <tr>
                    <td colspan="3">
                        <asp:RadioButtonList ID="rbtnSort" runat="server" AutoPostBack="True" RepeatDirection="Horizontal" OnSelectedIndexChanged="rbtnSort_SelectedIndexChanged">
                      ...
                      <asp:ListItem>Select</asp:ListItem>
                         ...
                         <asp:DropDownList ID="ddlYears" runat="server" DataSourceID="DSYears" DataTextField="year" DataValueField="year" AutoPostBack="True" AppendDataBoundItems="true" OnSelectedIndexChanged="ddlYears_SelectedIndexChanged" CssClass="txtBox">
                                                    <asp:ListItem Value="0" Text="Select Year">Select Year</asp:ListItem>
                                                </asp:DropDownList>
                  </asp:DropDownList>
                    </td>
                            ...
                            <MasterTableView AutoGenerateColumns="False">
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Edit" AllowFiltering="False" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Top"
                                        ...
                                        <ItemTemplate>
                                            <a href='Add_bod.aspx?id=<%# Eval("id") %>'>
