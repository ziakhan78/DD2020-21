<%@ Page Title="" Language="C#" MasterPageFile="~/masterpages/AdminM.master" AutoEventWireup="true" CodeFile="view_upcoming_bod.aspx.cs" Inherits="Admin_view_upcoming_bod" %>
 ...
 <asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
      <table style="width:100%;" class="txt" >
            ...
            <tr>              
               <td colspan="3" class="header_title">View Upcoming Board Members
               </td>
            </tr>
								...
								<tr>
										<td  vAlign="top" borderColor="#ffffff" align="left"  >
                                           <asp:RadioButtonList ID="rbtnSearch" runat="server" 
                                                ...
                                                <asp:ListItem Value="2">Club Wise</asp:ListItem>
       ...
       <td colspan="3">
           <telerik:RadGrid ID="RadGrid1" runat="server" AllowPaging="True" 
               ...
               Skin="WebBlue" onitemcommand="RadGrid1_ItemCommand" PageSize="25" 
...
<HeaderStyle Width="20px"></HeaderStyle>
    ...
    <Columns>     
        ...
        <telerik:GridTemplateColumn  HeaderText="Edit" AllowFiltering="False"  HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Top" 
                     ...
                     <ItemTemplate>
                             <a href='add_upcoming_bod.aspx?id=<%# Eval("id") %>'>Edit</a>
                         </ItemTemplate>
...
<telerik:GridTemplateColumn HeaderText="Action" AllowFiltering="false" HeaderStyle-Font-Underline="false">        
          ...
          <%-- <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
               ...
               SelectCommand="SELECT [id], (fname +' '+ lname) as Name, [designation], [added_date], [status] FROM [bod_upcoming_tbl] WHERE ([DistrictClubID] = @DistrictClubID) ORDER BY Name asc">
               
               <SelectParameters>
                   <asp:SessionParameter Name="DistrictClubID" SessionField="DistrictClubID" Type="Int32" />
               </SelectParameters>
