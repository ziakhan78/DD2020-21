<%@ Page Language="C#" MasterPageFile="~/masterpages/AdminM.master" AutoEventWireup="true" CodeFile="view_past_district_gove.aspx.cs" Inherits="admin_view_past_district_gove" Title="" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <table style="width: 100%;" class="txt">
                ...
                <tr>
                    <td colspan="3" class="header_title">View District Governors & Past District Governors
                    </td>
                </tr>
                                        ...
                                        <table width="100%">
                                            ...
                                            <tr>
                                                <td valign="top" bordercolor="#ffffff" align="left">
                                                    ...
                                                    <asp:DropDownList ID="DDLRCof" runat="server" AutoPostBack="True" AppendDataBoundItems="true"
                                                        DataSourceID="DSRCof" DataTextField="club_name" DataValueField="club_name"
                                                        CssClass="txt1" OnSelectedIndexChanged="DDLRCof_SelectedIndexChanged">
                                                        <asp:ListItem>Select RC Name</asp:ListItem>
                                                    </asp:DropDownList>
                                                    <asp:SqlDataSource ID="DSRCof" runat="server"
                                                        ConnectionString="<%$ ConnectionStrings:ConnString %>"
                                                        SelectCommand="SELECT distinct club_name FROM [past_district_gov_tbl] order by year desc"></asp:SqlDataSource>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="left">
                ...
                <tr>
                    <td colspan="3">
                        <telerik:RadGrid ID="RadGrid1" runat="server" AllowPaging="True"
                            ...
                            Skin="Default" OnItemCommand="RadGrid1_ItemCommand" PageSize="50"
                            ...
                            <MasterTableView AutoGenerateColumns="False" DataKeyNames="id">
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridBoundColumn HeaderStyle-Font-Underline="true"
                                        DataField="year" HeaderText="Year" SortExpression="year" UniqueName="year">
                                    </telerik:GridBoundColumn>

                                    <telerik:GridBoundColumn DataField="rotarian_name" HeaderText="Name of the Rotarian" HeaderStyle-Font-Underline="true"
                                        SortExpression="rotarian_name" UniqueName="rotarian_name">
                                    </telerik:GridBoundColumn>
                                    ...
                                    <telerik:GridBoundColumn DataField="club_name" HeaderText="Rotary Club of" HeaderStyle-Font-Underline="true"
                                        SortExpression="club_name" UniqueName="club_name">
                                    </telerik:GridBoundColumn>

                                    <telerik:GridTemplateColumn HeaderText="Edit" AllowFiltering="False">
                                        <ItemTemplate>
                                            <a href='add_past_district_gove.aspx?id=<%# Eval("id") %>'>Edit</a>
                                        </ItemTemplate>
                       ...
                       <%-- <asp:SqlDataSource ID="SqlDataSource1" runat="server"
                            ConnectionString="<%$ ConnectionStrings:ConnString %>"
                            SelectCommand="SELECT ROW_NUMBER () OVER (ORDER BY year) AS RowNumber,* FROM [past_district_gov_tbl] ORDER BY [year] desc"></asp:SqlDataSource>--%>
                    </td>
                </tr>
