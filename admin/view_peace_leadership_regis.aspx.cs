...
public partial class admin_view_peace_leadership_regis : System.Web.UI.Page
{
    ...
    { 
        ...
        obj.SetCommandQry = "SELECT * FROM View_Peace_Leadership_Seminar where club_id='" + clubid + "' order by name ";
        dt = obj.ExecuteTable();
        if (dt.Rows.Count > 0)
        {
    ...
    {        
        DataTable dt = new DataTable();
        DBconnection obj = new DBconnection();
        obj.SetCommandQry = "SELECT * FROM View_Peace_Leadership_Seminar order by name ";
        dt = obj.ExecuteTable();
        if (dt.Rows.Count > 0)
        {
            lblMsg.Visible = false;
    ...
    private void SearchGrid(string name)
    {
        ...
        obj.SetCommandQry = "SELECT * FROM View_Peace_Leadership_Seminar where name like +'" + name + "'+ '%' ";
