<%@ Page Language="C#" MasterPageFile="~/masterpages/AdminM.master" AutoEventWireup="true" CodeFile="view_bod_position.aspx.cs" Inherits="user_view_bod_position" Title="" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <table width="100%" class="txt">
                ...
                <tr>
                    <td colspan="3" class="header_title">View BOD Positions
                    </td>
                </tr>
                                        ...
                                        <tr>
                                            <td valign="top" bordercolor="#ffffff" align="left">
                                                <asp:RadioButtonList ID="rbtnSearch" runat="server"
                                                    ...
                                                    <asp:ListItem Selected="True" Value="0">Positions</asp:ListItem>
                ...
                <tr>
                    <td colspan="3">
                        <telerik:RadGrid ID="RadGrid1" runat="server" AllowPaging="True"
                            AllowSorting="True" OnItemCommand="RadGrid1_ItemCommand" PageSize="25"
                            ...
                            <MasterTableView AutoGenerateColumns="False" DataKeyNames="id">
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Sr.">
                                        ...
                                        <HeaderStyle Font-Bold="true" HorizontalAlign="Left" Width="20px" />
                                        <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" Width="20px" />
                                    </telerik:GridTemplateColumn>

                                    <telerik:GridBoundColumn DataField="designation" HeaderText="Positions"
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Action" AllowFiltering="False">
                                        <ItemTemplate>
                                            <a href='add_bod_position.aspx?id=<%# Eval("id") %>'>
