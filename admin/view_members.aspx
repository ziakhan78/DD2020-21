<%@ Page Title="" Language="C#" MasterPageFile="~/masterpages/AdminM.master" AutoEventWireup="true" CodeFile="view_members.aspx.cs" Inherits="admin_view_members" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <table style="width: 100%;" class="txt">
                ...
                <tr>
                    <td colspan="2" class="header_title">View Members
                    </td>
                </tr>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Mobile" SortExpression="Mobile">
                                     ...
                                     <telerik:GridTemplateColumn HeaderText="Status" SortExpression="MemType">
                                      ...
                                      <telerik:GridTemplateColumn HeaderText="Action" AllowFiltering="False" >
                                        <ItemTemplate>
                                            <a href='add_members.aspx?id=<%# Eval("MemberId") %>'><img src="../Admin_Icons/edit.gif" alt="Edit" border="0" title="Edit" /> </a>
                                        </ItemTemplate>
                                        ...
                                        <ItemTemplate>
                                          ...
                                          <cc1:ConfirmButtonExtender ID="ConfirmButtonExtender1" runat="server"
                                            ...
                                            <asp:ImageButton ID="imgDeleteP" runat="Server" AlternateText="Delete"
                                                CommandArgument='<%# Eval("MemberId") %>' CommandName="Delete"
