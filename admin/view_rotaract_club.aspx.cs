...
public partial class admin_view_rotaract_club : System.Web.UI.Page
{
    ...
    protected void RadGrid1_ItemCommand(object sender, Telerik.Web.UI.GridCommandEventArgs e)
    {
        ...
        if (e.CommandName == "Delete")
        {
            ...
            obj.SetCommandSP = "sp_DeleteRotaract";
            obj.AddParam("@id", uid);
    ...
    private void SearchByAlphabet(string name)
    {
        ...
        obj.SetCommandSP = "z_SearchByAlphabetRotaract";
    ...
    private void SearchGrid(string searchField, string pname)
    {
        ...
        obj.SetCommandQry = "SELECT ROW_NUMBER () OVER (ORDER BY club_name asc) AS RowNumber,pf_name+' '+isnull(pm_name,null)+' '+isnull(pl_name,null) as PName,sf_name+' '+isnull(sm_name,null)+' '+isnull(sl_name,null) as SName, * FROM [rotaract_club_tbl] where " + searchField + " like  +'%'+'" + pname + "'+ '%' ";
        dt = obj.ExecuteTable();
        if (dt.Rows.Count > 0)
        {
            //txtName.Text = "";
