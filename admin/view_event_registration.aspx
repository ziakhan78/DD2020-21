 ...
 <telerik:GridTemplateColumn HeaderText="Action" AllowFiltering="false" HeaderStyle-Font-Underline="false">        
            <ItemTemplate>
             ...
             <ItemStyle HorizontalAlign="Center" Width="30px" VerticalAlign="Top" />
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnStringridist3140 %>" SelectCommand="SELECT * FROM [Dist_Event_Reg_Master_tbl] order by event_date desc"></asp:SqlDataSource>
