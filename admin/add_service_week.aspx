<%@ Page Title="" Language="C#" MasterPageFile="~/masterpages/AdminM.master" ValidateRequest="false" AutoEventWireup="true" CodeFile="add_service_week.aspx.cs" Inherits="admin_add_service_week" %>
...
<%--   <asp:UpdatePanel ID="UpdatePanel1" runat="server" >
    <ContentTemplate>--%>
      ...
      <table style="width:100%;" border="0" class="txt" align="center" cellpadding="0" cellspacing="5" >
            ...
            <tr>
               <td colspan="3" class="header_title">Add Service Week
               </td>
            </tr> 
            ...
            <tr>
                <td class="style3" valign="top">Service Week</td>
                <td class="style1" valign="top">:</td>
                <td>
                    <telerik:RadEditor ID="txtServiceWeek" Runat="server">
                    </telerik:RadEditor>
                </td>
            </tr>
            ...
            <tr>
              ...
              <td><div align="left">
                  ...
                  <asp:RequiredFieldValidator ID="RFVThArea" runat="server" 
                      ControlToValidate="txtServiceWeek" Display="None" 
