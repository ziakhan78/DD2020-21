<%@ Page Title="" Language="C#" MasterPageFile="~/masterpages/AdminM.master" AutoEventWireup="true" CodeFile="rpt_events_registration.aspx.cs" Inherits="admin_rpt_events_registration" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table width="100%" class="txt">
        <tr>
            <td class="header_title">Events Registration Report
            </td>
        </tr>
        ...
        <tr>
            <td>
                ...
                <asp:RadioButtonList ID="rbtnType" runat="server"
                    ...
                    <asp:ListItem Value="3">By Cheque</asp:ListItem>
                    <asp:ListItem Value="4">By Cash</asp:ListItem>
                    <asp:ListItem Value="5">Invitee</asp:ListItem>
                    <asp:ListItem Value="6">Co-Host</asp:ListItem>
        ...
        <tr>
          ...
          <tr><td align="center" colspan="3">
             ...
             <asp:Label ID="lblMsg" runat="server" Text="No records to display." Visible="false"  
                style="font-weight:bold; font-size:14px; color:#FF0000; background-color:Black; padding:5px 5px 5px 5px;"></asp:Label></td></tr>
    </table>
</asp:Content>
