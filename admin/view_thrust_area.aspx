<%@ Page Title="" Language="C#" MasterPageFile="~/masterpages/AdminM.master" AutoEventWireup="true" CodeFile="view_thrust_area.aspx.cs" Inherits="admin_view_thrust_area" %>
   ...
   <asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
      <table style="width:100%;" class="txt" >
            ...
            <tr>              
               <td colspan="3" class="header_title">View District Thrust Area
               </td>
            </tr>
       ...
       <td colspan="3">
           <telerik:RadGrid ID="RadGrid1" runat="server" AllowPaging="True"
               AllowSorting="True" DataSourceID="DSThArea" 
...
<MasterTableView autogeneratecolumns="False" datasourceid="DSThArea" DataKeyNames="id">
<RowIndicatorColumn>
...
<HeaderStyle Width="20px"></HeaderStyle>
    ...
    <Columns>
        ...
        <ItemStyle Width="20px" VerticalAlign="Top" HorizontalAlign="Left"></ItemStyle>
         ...
         <telerik:GridBoundColumn DataField="thrustarea" HeaderText="District Thrust Area" 
            SortExpression="thrustarea" UniqueName="thrustarea">
      ...
      <telerik:GridTemplateColumn  HeaderText="Edit" AllowFiltering="False" >
                     <ItemTemplate>
                             <a href='add_thrust_area.aspx?id=<%# Eval("id") %>'>Edit</a>
                         </ItemTemplate>
...
<ItemStyle HorizontalAlign="Center" VerticalAlign="Top" Width="30px"></ItemStyle>
 ...
 <telerik:GridTemplateColumn HeaderText="Action" AllowFiltering="false" HeaderStyle-Font-Underline="false">        
           ...
           <asp:SqlDataSource ID="DSThArea" runat="server" 
               ConnectionString="<%$ ConnectionStrings:ConnStringridist3140 %>" 
               SelectCommand="SELECT * FROM [dist_thrustarea_tbl] ORDER BY id desc">
           </asp:SqlDataSource>
