<%@ Page Language="C#" MasterPageFile="~/masterpages/AdminM.master" AutoEventWireup="true" CodeFile="view_clubs.aspx.cs" Inherits="admin_view_clubs" Title="" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <table style="width: 100%;" class="txt">
                ...
                <tr>
                    <td colspan="3" class="header_title">View Clubs</td>
                </tr>
        ...
        <ItemStyle Width="20px" VerticalAlign="Top" HorizontalAlign="Left"></ItemStyle>
                                        ...
                                        <telerik:GridTemplateColumn HeaderText="Rotary Club of" SortExpression="club_name">
                                            <ItemTemplate>
                                                <a href="javascript:void(0)" onclick="MM_openBrWindow('view_club_details.aspx?id=<%# Eval("id") %>','01111','width=1060, height=550')"><%# Eval("club_name") %></a>
                                            </ItemTemplate>
        ...
        <ItemStyle VerticalAlign="Top" HorizontalAlign="Left"></ItemStyle>
                                        ...
                                        <telerik:GridTemplateColumn HeaderText="Venue" AllowSorting="false">
                                            <ItemTemplate>
                                                <%# Eval("venue1") %>&nbsp;<%# Eval("venue2") %>
                                            </ItemTemplate>
                                            <HeaderStyle Font-Underline="false" />
                                        </telerik:GridTemplateColumn>
                                        ...
                                        <telerik:GridBoundColumn DataField="meeting_day" HeaderText="Day" SortExpression="meeting_day" UniqueName="meeting_day">
                                            <ItemStyle Width="70px" VerticalAlign="Top" HorizontalAlign="Left"></ItemStyle>
                                        </telerik:GridBoundColumn>

                                        <telerik:GridBoundColumn DataField="meeting_time" HeaderText="Time" SortExpression="meeting_time" UniqueName="meeting_time" DataFormatString="{0:hh:mm tt}">
                                            <ItemStyle Width="60px" VerticalAlign="Top" HorizontalAlign="Left"></ItemStyle>
                                        </telerik:GridBoundColumn>

                                        <telerik:GridBoundColumn DataField="ri_club_No" HeaderText="Club No." SortExpression="ri_club_No" UniqueName="ri_club_No">
         ...
         <telerik:GridBoundColumn DataField="MemStrength" HeaderText="Strength" SortExpression="MemStrength" UniqueName="MemStrength">
            <ItemStyle Width="50px" VerticalAlign="Top" HorizontalAlign="Left"></ItemStyle>
                                        ...
                                        <telerik:GridBoundColumn DataField="charter_date" HeaderText="Charter Date" SortExpression="charter_date" UniqueName="charter_date" DataFormatString="{0:dd-MMM-yyyy}">
                                        ...
                                        <telerik:GridTemplateColumn HeaderText="Edit" AllowFiltering="False">
                                            <ItemTemplate>
                                                <a href='add_clubs.aspx?id=<%# Eval("id") %>'>
                    ...
                    <tr>
                        <td align="center" colspan="4">
                            <asp:Label ID="lblMsg" runat="server" Text="No records to display." Visible="false" CssClass="txt_validation"></asp:Label></td>
                    </tr>
            </table>
