<%@ Page Title="" Language="C#" MasterPageFile="~/masterpages/AdminM.master" AutoEventWireup="true" CodeFile="view_service_week.aspx.cs" Inherits="admin_view_service_week" %>
   ...
   <asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
      <table style="width:100%;" class="txt" >
            ...
            <tr>              
               <td colspan="3" class="header_title">View Service Week
               </td>
            </tr>
       ...
       <td colspan="3">
           <telerik:RadGrid ID="RadGrid1" runat="server" AllowPaging="True"
               AllowSorting="True" DataSourceID="DSServiceWeek" 
               Skin="WebBlue"  PageSize="100" onitemcommand="RadGrid1_ItemCommand">
<HeaderContextMenu EnableAutoScroll="True"></HeaderContextMenu>

<MasterTableView autogeneratecolumns="False" datasourceid="DSServiceWeek" DataKeyNames="id">
<RowIndicatorColumn>
...
<HeaderStyle Width="20px"></HeaderStyle>
    ...
    <Columns>
        ...
        <ItemStyle Width="20px" VerticalAlign="Top" HorizontalAlign="Left"></ItemStyle>
         ...
         <telerik:GridBoundColumn DataField="service_week" HeaderText="Service Week" 
            SortExpression="service_week" UniqueName="service_week">
      ...
      <telerik:GridTemplateColumn  HeaderText="Edit" AllowFiltering="False" >
                     <ItemTemplate>
                             <a href='add_service_week.aspx?id=<%# Eval("id") %>'>Edit</a>
                         </ItemTemplate>
...
<ItemStyle HorizontalAlign="Center" VerticalAlign="Top" Width="30px"></ItemStyle>
 ...
 <telerik:GridTemplateColumn HeaderText="Action" AllowFiltering="false" HeaderStyle-Font-Underline="false">        
           ...
           <asp:SqlDataSource ID="DSServiceWeek" runat="server" 
               ConnectionString="<%$ ConnectionStrings:ConnStringridist3140 %>" 
               SelectCommand="SELECT * FROM [service_week_tbl] ORDER BY id desc">
           </asp:SqlDataSource>
