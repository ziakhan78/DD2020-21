...
public partial class admin_add_dollar_rupee_conversion : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {           
            lblHeading.Text = "Add Dollar Rupee Conversion";
    ...
    private void GetDollorRate(int id)
    {
        ...
        if (dt.Rows.Count > 0)
        {
            lblHeading.Text = "Edit Dollar Rupee Conversion";
