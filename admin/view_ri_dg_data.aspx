<%@ Page Language="C#" MasterPageFile="~/masterpages/AdminM.master" AutoEventWireup="true" CodeFile="view_ri_dg_data.aspx.cs" Inherits="admin_view_ri_dg_data" Title="" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <table style="width: 100%;" class="txt">
                ...
                <tr>
                    <td colspan="3" class="header_title">View RI & District Governors
                    </td>
                </tr>
                        ...
                        <telerik:RadGrid ID="RadGrid1" runat="server" AllowPaging="True"
                            ...
                            <MasterTableView AutoGenerateColumns="False" DataKeyNames="id">
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Image" AllowFiltering="False" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Top"
                                        ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Top" ItemStyle-Width="40px" HeaderStyle-Width="40px">
                                        <ItemTemplate>
                                            <img src="../RIDGImages/<%# Eval("image") %>" alt="" border="0" title="<%# Eval("name") %>" height="70px" width="70px" /> </a>
                                        </ItemTemplate>
                                    ...
                                    <telerik:GridBoundColumn HeaderStyle-Font-Underline="true"
                                     ...
                                     <telerik:GridBoundColumn DataField="designation" HeaderText="Designation" HeaderStyle-Font-Underline="true"
                                        SortExpression="designation" UniqueName="designation">
                                    </telerik:GridBoundColumn>

                                    <telerik:GridBoundColumn DataField="name" HeaderText="Name of the Rotarian" HeaderStyle-Font-Underline="true"
                                    ...
                                    <telerik:GridBoundColumn DataField="club_name" HeaderText="Rotary Club of" HeaderStyle-Font-Underline="true"
                                      ...
                                      <telerik:GridTemplateColumn HeaderText="Action" AllowFiltering="False" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Top"
                                        ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Top" ItemStyle-Width="40px" HeaderStyle-Width="40px">
                                        <ItemTemplate>
                                            <a href='add_ri_dg_data.aspx?id=<%# Eval("id") %>'><img src="../Admin_Icons/edit.gif" alt="Edit" border="0" title="Edit" /> </a>
                                        </ItemTemplate>
                                        <HeaderStyle HorizontalAlign="Center" VerticalAlign="Top"></HeaderStyle>
                                        <ItemStyle HorizontalAlign="Center" VerticalAlign="Top" Width="40px"></ItemStyle>
                                    </telerik:GridTemplateColumn>
