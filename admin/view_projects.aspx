<%@ Page Title="" Language="C#" MasterPageFile="~/masterpages/AdminM.master" AutoEventWireup="true" CodeFile="view_projects.aspx.cs" Inherits="admin_view_projects" %>
                ...
                <tr>
                    <td colspan="3">
                        <telerik:RadGrid ID="RadGrid1" runat="server" AllowPaging="True"
                            AllowSorting="True" Skin="WebBlue" PageSize="100" OnItemCommand="RadGrid1_ItemCommand"
                            OnPageIndexChanged="RadGrid1_PageIndexChanged"
                            OnPageSizeChanged="RadGrid1_PageSizeChanged"
                            OnSortCommand="RadGrid1_SortCommand" GridLines="None" CellSpacing="0">
                            ...
                            <MasterTableView AutoGenerateColumns="False" DataKeyNames="id">
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridBoundColumn DataField="project_cost" DataType="System.Decimal" FilterControlAltText="Filter project_cost column" HeaderText="Project Cost" SortExpression="project_cost" UniqueName="project_cost" DataFormatString="{0:n}">
                                        <ColumnValidationSettings>
                                            <ModelErrorMessage Text="" />
                                        </ColumnValidationSettings>
                                    </telerik:GridBoundColumn>
