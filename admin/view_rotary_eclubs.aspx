<%@ Page Title="" Language="C#" MasterPageFile="~/masterpages/AdminM.master" AutoEventWireup="true" CodeFile="view_rotary_eclubs.aspx.cs" Inherits="admin_view_rotary_eclubs" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
      <table style="width:100%;" class="txt" >
            ...
            <tr>              
               <td colspan="3" class="header_title">View Rotary E-Clubs
               </td>
            </tr>
       ...
       <td colspan="3">
           <telerik:RadGrid ID="RadGrid1" runat="server" AllowPaging="True"
               AllowSorting="True" DataSourceID="DSEclubs" 
...
<MasterTableView autogeneratecolumns="False" datasourceid="DSEclubs" DataKeyNames="id">
<RowIndicatorColumn>
...
<HeaderStyle Width="20px"></HeaderStyle>
    ...
    <Columns>
        ...
        <ItemStyle Width="20px" VerticalAlign="Top" HorizontalAlign="Left"></ItemStyle>
         ...
         <telerik:GridBoundColumn DataField="club_name" HeaderText="E-Club Name" 
         ...
         <telerik:GridBoundColumn DataField="day" HeaderText="Day" 
            SortExpression="day" UniqueName="day">
      ...
      <telerik:GridTemplateColumn  HeaderText="Edit" AllowFiltering="False" >
                     <ItemTemplate>
                             <a href='add_rotary_eclubs.aspx?id=<%# Eval("id") %>'>Edit</a>
                         </ItemTemplate>
...
<ItemStyle HorizontalAlign="Center" VerticalAlign="Top" Width="30px"></ItemStyle>
 ...
 <telerik:GridTemplateColumn HeaderText="Action" AllowFiltering="false" HeaderStyle-Font-Underline="false">        
           ...
           <asp:SqlDataSource ID="DSEclubs" runat="server" 
               ConnectionString="<%$ ConnectionStrings:ConnStringridist3140 %>" 
               SelectCommand="SELECT * FROM [rotary_eclubs_tbl] ORDER BY [club_name]">
           </asp:SqlDataSource>
