<%@ Page Title="" Language="C#" MasterPageFile="~/masterpages/AdminM.master" AutoEventWireup="true" CodeFile="view_tashkent_registrations_payment_report.aspx.cs" Inherits="admin_view_tashkent_registrations_payment_report" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table style="width: 100%;" class="txt">
        ...
        <tr>
            <td colspan="3" class="header_title">View Tashkent Registrations Payment Report
            </td>
        </tr>
                    ...
                    <MasterTableView AutoGenerateColumns="False" DataKeyNames="id">
                        ...
                        <Columns>
                          ...
                          <%--  <telerik:GridBoundColumn DataField="added_date" HeaderText="Reg. Date"
                            ...
                            <telerik:GridBoundColumn DataField="bank_name" FilterControlAltText="Filter bank_name column" HeaderText="Bank Name" SortExpression="bank_name" UniqueName="bank_name">
                                <ColumnValidationSettings>
                                    <ModelErrorMessage Text="" />
                                </ColumnValidationSettings>
                            </telerik:GridBoundColumn>

                            <telerik:GridBoundColumn DataField="cheque_no" FilterControlAltText="Filter cheque_no column" HeaderText="Cheque No." SortExpression="cheque_no" UniqueName="cheque_no">
                                <ColumnValidationSettings>
                                    <ModelErrorMessage Text="" />
                                </ColumnValidationSettings>
                            </telerik:GridBoundColumn>

                            <telerik:GridBoundColumn DataField="cheque_date" HeaderText="Cheque Date"
                                SortExpression="cheque_date" UniqueName="cheque_date" DataType="System.DateTime" FilterControlAltText="Filter cheque_date column" DataFormatString="{0:dd/MM/yyyy}">
                                <ColumnValidationSettings>
                                    <ModelErrorMessage Text="" />
                                </ColumnValidationSettings>
                            </telerik:GridBoundColumn>
