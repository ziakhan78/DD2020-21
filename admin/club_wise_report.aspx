<%@ Page Title="" Language="C#" MasterPageFile="~/masterpages/AdminM.master" AutoEventWireup="true" CodeFile="club_wise_report.aspx.cs" Inherits="admin_club_wise_report" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table width="100%" border="0" class="txt" align="center" cellpadding="0" cellspacing="5">
        ...
        <tr>
            <td colspan="2" class="header_title">Club Wise Report
            </td>
        </tr>
