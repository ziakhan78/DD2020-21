<%@ Page Title="" Language="C#" MasterPageFile="~/masterpages/AdminM.master" AutoEventWireup="true" CodeFile="rpt_3rd_trf_clubwise_all_reg.aspx.cs" Inherits="admin_rpt_3rd_trf_clubwise_all_reg" %>
...
<table  width="100%" class="txt">
        <tr>           
               <td class="header_title">3rd TRF Seminar Registration Report - Clubwise
               </td>
        </tr>
         ...
         <tr>           
               <td >
                   ...
                   <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                       ...
                       SelectCommand="Select ROW_NUMBER () OVER (ORDER BY club_name asc) AS Sr, * from View_TRF_Seminar order by club_name, Name, regis_no " >
                   </asp:SqlDataSource>
