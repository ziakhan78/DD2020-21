<%@ Page Title="" Language="C#" MasterPageFile="~/masterpages/AdminM.master" AutoEventWireup="true" CodeFile="view_roll_of_honour.aspx.cs" Inherits="Admin_view_roll_of_honour" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <table style="width: 100%;" class="txt">
                ...
                <tr>
                    <td colspan="3" class="header_title">View Roll of Honour
                    </td>
                </tr>
                ...
                <tr>
                    <td valign="top" align="left" width="430px">
                        <table width="200">
                            <tr>
                    ...
                    <td valign="top" width="450px" align="right">
                            ...
                            <tr>
                                ...
                                <td valign="top" align="right" width="100%">
                                    <table width="100%">
                                        ...
                                        <tr>
                                            <td valign="top" bordercolor="#ffffff" align="center">Club Name :
                                            <asp:DropDownList ID="DDLClubName" runat="server" AppendDataBoundItems="true"
                                                AutoPostBack="True" CssClass="txt" DataSourceID="DSDistClubNo"
                                        ...
                                        <tr>
                                            <td valign="top" bordercolor="#ffffff" align="center">
                                                <asp:RadioButtonList ID="rbtnSearch" runat="server" AutoPostBack="True"
                                                    ...
                                                    <asp:ListItem Value="0">President</asp:ListItem>
            ...
            ReadOnly="True">
                                    ...
                                    <telerik:GridBoundColumn DataField="president" HeaderText="President"
                                        ...
                                        <ItemStyle Width="300px" VerticalAlign="Top"></ItemStyle>
                                        <HeaderStyle Width="300px" />

                                    </telerik:GridBoundColumn>

                                    <telerik:GridBoundColumn DataField="secretary" ItemStyle-VerticalAlign="Top"
                                        HeaderStyle-Font-Underline="false" HeaderStyle-Width="120px"
                                        HeaderText="Secretary" SortExpression="secretary"
            ...
            DataType="System.DateTime">
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Edit" AllowFiltering="False" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Top"
                                        ...
                                        <ItemTemplate>
                                            <a href='add_roll_of_honour.aspx?id=<%# Eval("id") %>'>
