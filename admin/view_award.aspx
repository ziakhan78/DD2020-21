<%@ Page Title="" Language="C#" MasterPageFile="~/masterpages/AdminM.master" AutoEventWireup="true" CodeFile="view_award.aspx.cs" Inherits="admin_view_award" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <table style="width: 100%;" class="txt">
                ...
                <tr>
                    <td colspan="3" class="header_title">View District Awards
                    </td>
                </tr>
                                            ...
                                            <tr>
                                                <td valign="top" bordercolor="#ffffff" align="left">
                                                    <asp:RadioButtonList ID="rbtnSearch" runat="server"
                                                        ...
                                                        <asp:ListItem Selected="True" Value="0">Award Name</asp:ListItem>
                ...
                <tr>
                    <td colspan="3">
                        <telerik:RadGrid ID="RadGrid1" runat="server" AllowPaging="True"
                            AllowSorting="True" DataSourceID="DSAward"
                            Skin="Default" PageSize="100" OnItemCommand="RadGrid1_ItemCommand"
                            OnPageIndexChanged="RadGrid1_PageIndexChanged"
                            OnPageSizeChanged="RadGrid1_PageSizeChanged"
                            OnSortCommand="RadGrid1_SortCommand">
                            <HeaderContextMenu EnableAutoScroll="True"></HeaderContextMenu>
                            <MasterTableView AutoGenerateColumns="False" DataSourceID="DSAward" DataKeyNames="award_id">
                                <RowIndicatorColumn>
...
<ItemStyle Width="20px" VerticalAlign="Top" ></ItemStyle>
                                    ...
                                    <telerik:GridBoundColumn DataField="award_name" HeaderText="Award Name"
                                    ...
                                    <telerik:GridBoundColumn DataField="donor" HeaderText="Donor"
                                        SortExpression="donor" UniqueName="donor">

                                        <ItemStyle VerticalAlign="Top" Width="150px" />
                                    </telerik:GridBoundColumn>

                                    <telerik:GridBoundColumn DataField="constituted_on" HeaderText="Constituted In"
                                        SortExpression="constituted_on" UniqueName="constituted_on">
                                        <ItemStyle VerticalAlign="Top" Width="90px" />
                                    </telerik:GridBoundColumn>

                                    <telerik:GridTemplateColumn HeaderText="Edit" AllowFiltering="False">
                                        <ItemTemplate>
                                            <a href='add_award.aspx?id=<%# Eval("award_id") %>'>Edit</a>
                                        </ItemTemplate>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Action" AllowFiltering="false" HeaderStyle-Font-Underline="false">
                                        <ItemTemplate>
                                            ...
                                            <asp:ImageButton ID="imgDeleteP" CommandName="Delete" ToolTip="Delete"
                                                CommandArgument='<%# Eval("award_id") %>' runat="Server"
                        ...
                        <asp:SqlDataSource ID="DSAward" runat="server"
                            ConnectionString="<%$ ConnectionStrings:ConnString %>"
                            SelectCommand="SELECT  * FROM [award_master_tbl] ORDER BY [award_id]"></asp:SqlDataSource>
