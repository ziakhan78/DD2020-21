<%@ Page Title="" Language="C#" MasterPageFile="~/masterpages/AdminM.master" AutoEventWireup="true" CodeFile="rpt_3rd_trf_registration_by_club.aspx.cs" Inherits="admin_rpt_registration_by_club" %>
...
<table  width="100%" class="txt">
        <tr>           
               <td class="header_title">Maximum Registration By Club Report
               </td>
        </tr>
         ...
         <tr>           
               <td >
                   ...
                   <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                       ...
                       SelectCommand="Select ROW_NUMBER () OVER (ORDER BY Name asc) AS Sr, * from View_Peace_Leadership_Seminar where club_name=(select top 1 club_name from View_PeaceMaxNoClub where club_name !=' ' order by maxnoofclub desc) order by Name" >
                   </asp:SqlDataSource>
