<%@ Page Title="" Language="C#" MasterPageFile="~/masterpages/AdminM.master" AutoEventWireup="true" CodeFile="view_avenues_of_service.aspx.cs" Inherits="admin_view_avenues_of_service" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   ...
   <table style="width:100%;" class="txt" >
        ...
        <tr>
            <td colspan="3" class="header_title">View Avenues Of Serviceb Citation</td>
        </tr>
        ...
        <tr>
            <td>
                    ...
                    <MasterTableView autogeneratecolumns="False" datasourceid="DSDonors" DataKeyNames="id">
                        ...
                        <Columns>
                            ...
                            <telerik:GridTemplateColumn  HeaderText="Edit" AllowFiltering="False"  HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Top" 
                                ...
                                <ItemTemplate>
                                    <a href='add_avenues_of_service_citation.aspx?id=<%# Eval("id") %>'>Edit</a>
                                </ItemTemplate>
                ...
                <asp:SqlDataSource ID="DSDonors" runat="server" 
                                   ...
                                   SelectCommand="SELECT (fname+' '+ mname+' '+lname) as Name,* FROM avenues_of_service_tbl order by years desc, fname,mname,lname">
                </asp:SqlDataSource>
            </td>
        </tr>
    </table>
