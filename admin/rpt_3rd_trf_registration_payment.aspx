<%@ Page Title="" Language="C#" MasterPageFile="~/masterpages/AdminM.master" AutoEventWireup="true" CodeFile="rpt_3rd_trf_registration_payment.aspx.cs" Inherits="admin_rpt_3rd_trf_registration_payment" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   <table  width="100%" class="txt">
        <tr>           
               <td class="header_title">3rd TRF Seminar Registration Payment Status Report
               </td>
        </tr>
