<%@ Page Title="" Language="C#" MasterPageFile="~/masterpages/AdminM.master" AutoEventWireup="true" CodeFile="view_ocv_cal.aspx.cs" Inherits="admin_view_ocv_cal" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <table style="width: 100%;" class="txt">
                ...
                <tr>
                    <td colspan="3" class="header_title">View OCV Calendar
                    </td>
                </tr>
                ...
                <tr>
                    <td colspan="3">
                        <telerik:RadGrid ID="RadGrid1" runat="server" AllowPaging="True"
                            AllowSorting="True" DataSourceID="DSOcvCal"
                            ...
                            <MasterTableView AutoGenerateColumns="False" DataSourceID="DSOcvCal" DataKeyNames="id">
                                <RowIndicatorColumn>
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Edit" AllowFiltering="False">
                                        <ItemTemplate>
                                            <a href='add_ocv_cal.aspx?id=<%# Eval("id") %>'>Edit</a>
                                        </ItemTemplate>
                        ...
                        <asp:SqlDataSource ID="DSOcvCal" runat="server"
                            ConnectionString="<%$ ConnectionStrings:ConnString %>"
                            SelectCommand="z_GetOcvSchedule" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
