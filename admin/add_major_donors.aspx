<%@ Page Title="" Language="C#" MasterPageFile="~/masterpages/AdminM.master" AutoEventWireup="true" CodeFile="add_major_donors.aspx.cs" Inherits="admin_add_major_donors" %>
    ...
    <ContentTemplate>
     ...
     <table style="width:100%;" border="0" class="txt" align="center" cellpadding="0" cellspacing="5" >
            ...
            <tr>
               ...
               <td colspan="3" class="header_title">Add Major Donors</td>
            </tr>
           <tr>
            ...
            <tr>
                <td class="style3">
                    <span class="style2">*</span>Select Level</td>
                <td>
                    :</td>
                <td class="style1">
                    <asp:DropDownList ID="ddlLevel" runat="server" CssClass="txt" >
                    <asp:ListItem>Select</asp:ListItem>
                        <asp:ListItem>Level One</asp:ListItem>
                        <asp:ListItem>Level Two</asp:ListItem>
                        <asp:ListItem>Level Three</asp:ListItem>
                        <asp:ListItem>Level Four</asp:ListItem>
                    </asp:DropDownList>
