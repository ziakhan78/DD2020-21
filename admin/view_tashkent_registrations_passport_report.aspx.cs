...
public partial class admin_view_tashkent_registrations_passport_report : System.Web.UI.Page
{
    ...
    protected void btnExporttoExcel_Click(object sender, EventArgs e)
    {
        ...
        RadGrid1.ExportSettings.FileName = "TashkentRegistrationsPassportReports_" + dt;
    ...
    private void BindGrid()
    {
        ...
        obj.SetCommandQry = "SELECT * FROM [View_PassportDetails]";
        dt = obj.ExecuteTable();       
        if (dt.Rows.Count > 0)
        {
            lblMsg.Visible = false;
