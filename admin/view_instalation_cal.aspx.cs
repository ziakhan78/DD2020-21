...
public partial class admin_view_instalation_cal : System.Web.UI.Page
{
    ...
    protected void RadGrid1_ItemCommand(object sender, Telerik.Web.UI.GridCommandEventArgs e)
    {
        if (e.CommandName == "Delete")
        {
            ...
            obj.SetCommandSP = "sp_DeleteInstalationCal";
            obj.AddParam("@id", id);
    ...
    private void SearchByAlphabet(string name)
    {
        ...
        obj.SetCommandSP = "z_SearchByAlphabetInstCal";
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        if (i == 2)
        {
            searchField = "(ISNULL(FName + ' ', ' ') + ISNULL(MName + ' ', ' ') + ISNULL(LName, NULL))";
        }
    ...
    private void SearchGrid(string searchField, string pname)
    {
        DataTable dt = new DataTable();
        DBconnection obj = new DBconnection();
        obj.SetCommandQry = "SELECT ISNULL(FName + ' ', ' ') + ISNULL(MName + ' ', ' ') + ISNULL(LName, NULL) AS President,* FROM [View_Installation_Cal] where datepart(year,date)='2013' and " + searchField + " like  '%'+'" + pname + "'+ '%' ";
        dt = obj.ExecuteTable();
        if (dt.Rows.Count > 0)
        {
