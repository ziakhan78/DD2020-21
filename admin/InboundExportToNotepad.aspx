<%@ Page Title="" Language="C#" MasterPageFile="~/masterpages/AdminM.master" AutoEventWireup="true" CodeFile="InboundExportToNotepad.aspx.cs" Inherits="admin_InboundExportToNotepad" %>
...
<Columns>
    ...
    <asp:BoundField DataField="emailId" HeaderText="emailId" ItemStyle-Width="250" />
                             ...
                             <asp:SqlDataSource ID="DSInbound" runat="server" ConnectionString="<%$ ConnectionStrings:ConnString %>" SelectCommand="SELECT distinct name, emailId from View_Inbound group by name, emailId order by name"></asp:SqlDataSource>
