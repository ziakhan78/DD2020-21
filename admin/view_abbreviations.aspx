<%@ Page Title="" Language="C#" MasterPageFile="~/masterpages/AdminM.master" AutoEventWireup="true" CodeFile="view_abbreviations.aspx.cs" Inherits="admin_view_abbreviations" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <table style="width: 100%;" class="txt">
                ...
                <tr>
                    <td colspan="3" class="header_title">View Abbreviations
                    </td>
                </tr>
                                        ...
                                        <tr>
                                            <td valign="top" bordercolor="#ffffff" align="left">
                                                <asp:RadioButtonList ID="rbtnSearch" runat="server"
                                                    ...
                                                    <asp:ListItem Selected="True" Value="0">Abbreviation</asp:ListItem>
...
<ItemStyle Width="20px"></ItemStyle>
                                    ...
                                    <telerik:GridBoundColumn DataField="abbreviation" HeaderText="Abbreviations"
                                        ItemStyle-Width="100px" HeaderStyle-Width="100px"
                                        SortExpression="abbreviation" UniqueName="abbreviation">
                                    </telerik:GridBoundColumn>

                                    <telerik:GridBoundColumn DataField="full_form" HeaderText="Full Form"
                                        SortExpression="full_form" UniqueName="full_form">
                                    </telerik:GridBoundColumn>
            ...
            HeaderText="added_date" SortExpression="added_date" UniqueName="added_date">
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Action" AllowFiltering="False" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Top"
                                        ...
                                        <ItemTemplate>
                                            <a href='add_abbreviation.aspx?id=<%# Eval("id") %>'><img src="../Admin_Icons/edit.gif" alt="Edit" border="0" title="Edit" /> </a>
                                        </ItemTemplate>
