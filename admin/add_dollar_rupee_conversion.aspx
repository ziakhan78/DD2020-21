<%@ Page Title="" Language="C#" MasterPageFile="~/masterpages/AdminM.master" AutoEventWireup="true" CodeFile="add_dollar_rupee_conversion.aspx.cs" Inherits="admin_add_dollar_rupee_conversion" %>
            ...
            <td align="left">
               <telerik:RadGrid ID="RadGrid1" runat="server" AllowPaging="True" DataSourceID="DSDollor"
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridBoundColumn DataField="dollor_rate" HeaderText="Dollor Rate"
                                     ...
                                     <telerik:GridTemplateColumn HeaderText="Action" AllowFiltering="False" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Top"
                                        ...
                                        <ItemTemplate>
                                            <a href='add_dollar_rupee_conversion.aspx?id=<%# Eval("id") %>'><img src="../Admin_Icons/edit.gif" alt="Edit" border="0" title="Edit" /> </a>
                                        </ItemTemplate>
                        ...
                        <asp:SqlDataSource ID="DSDollor" runat="server"
                            ...
                            SelectCommand="SELECT * FROM [dollor_rate_tbl] order by dollor_rate"></asp:SqlDataSource>
