<%@ Page Title="" Language="C#" MasterPageFile="~/masterpages/AdminM.master" AutoEventWireup="true" CodeFile="rpt_clubwise_all_reg.aspx.cs" Inherits="admin_rpt_clubwise_all_reg" %>
...
<table  width="100%" class="txt">
        <tr>           
               <td class="header_title">Peace Through Leadership Seminar Registration Report - Clubwise
               </td>
        </tr>
         ...
         <tr>           
               <td >
                   ...
                   <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                       ...
                       SelectCommand="Select ROW_NUMBER () OVER (ORDER BY club_name asc) AS Sr, * from View_Peace_Leadership_Seminar order by club_name" >
                   </asp:SqlDataSource>
