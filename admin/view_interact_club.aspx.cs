...
public partial class admin_view_interact_club : System.Web.UI.Page
{
    ...
    protected void RadGrid1_ItemCommand(object sender, Telerik.Web.UI.GridCommandEventArgs e)
    {
        ...
        if (e.CommandName == "Delete")
        {
            ...
            obj.SetCommandSP = "sp_DeleteInteract";
            obj.AddParam("@id", uid);
    ...
    private void SearchByAlphabet(string name)
    {
        ...
        obj.SetCommandSP = "z_SearchByAlphabetInterect";
    ...
    private void SearchGrid(string searchField, string pname)
    {
        ...
        obj.SetCommandQry = "SELECT ROW_NUMBER () OVER (ORDER BY club_name asc) AS RowNumber, * FROM [interact_club_tbl] where " + searchField + " like  '" + pname + "'+ '%' ";
