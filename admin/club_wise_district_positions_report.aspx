<%@ Page Title="" Language="C#" MasterPageFile="~/masterpages/AdminM.master" AutoEventWireup="true" CodeFile="club_wise_district_positions_report.aspx.cs" Inherits="admin_club_wise_district_positions_report" %>
            ...
            <td colspan="2">
                <asp:Panel ID="PanelSort" runat="server" Width="100%" GroupingText="Sort By" DefaultButton="btnSearch">
                   ...
                   <asp:RequiredFieldValidator ID="rfvName" runat="server" ControlToValidate="DDLMember" CssClass="txt_validation" Display="Dynamic" ErrorMessage="Select Member Name" InitialValue="Select" ValidationGroup="A"></asp:RequiredFieldValidator>
                    ...
                    <asp:TextBox ID="txtMemberName" runat="server"></asp:TextBox><asp:Button ID="btnSearch" runat="server" Text="Search" OnClick="btnSearch_Click" />
                </asp:Panel>
