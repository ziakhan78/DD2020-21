<%@ Page Title="" Language="C#" MasterPageFile="~/masterpages/AdminM.master" AutoEventWireup="true" CodeFile="rpt_cheque.aspx.cs" Inherits="admin_rpt_cheque" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table  width="100%" class="txt">
        <tr>           
               <td class="header_title">District Peace Leadership Registration Cheque Report
               </td>
        </tr>
         ...
         <tr>           
               <td align="center" >
                   ...
                   <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                       ...
                       SelectCommand="Select ROW_NUMBER () OVER (ORDER BY Name asc) AS Sr, * from View_Peace_Leadership_Seminar where payment_type='Cheque'" >
                   </asp:SqlDataSource>
