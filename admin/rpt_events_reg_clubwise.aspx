<%@ Page Title="" Language="C#" MasterPageFile="~/masterpages/AdminM.master" AutoEventWireup="true" CodeFile="rpt_events_reg_clubwise.aspx.cs" Inherits="admin_rpt_events_reg_clubwise" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table width="100%" class="txt">
        <tr>
            <td class="header_title">Events Registration Report - Club Name Wise
            </td>
        </tr>
